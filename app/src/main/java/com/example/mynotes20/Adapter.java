...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {//help us to implement search functionality
    Context context;
    Activity activity;
    ...
    public int getItemCount() {
        return notesList.size() ;//return item count of the list
    }
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0 )  //if we search something the length is equal to 0 or empty
            {
